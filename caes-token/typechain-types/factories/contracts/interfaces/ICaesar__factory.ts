...
import type {
  ICaesar,
  ICaesarInterface,
} from "../../../contracts/interfaces/ICaesar";
...
export class ICaesar__factory {
  static readonly abi = _abi;
  static createInterface(): ICaesarInterface {
    return new utils.Interface(_abi) as ICaesarInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICaesar {
    return new Contract(address, _abi, signerOrProvider) as ICaesar;
  }
}
