...
export interface IEconomicEngineInterface extends utils.Interface {
  functions: {
...
export interface IEconomicEngine extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEconomicEngineInterface;
